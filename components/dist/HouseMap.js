...
function HouseMap(_a) {
    ...
    react_1.useEffect(function () {
        var fetchCoordinates = function () { return __awaiter(_this, void 0, void 0, function () {
            var apiKey, response, data, _a, lat, lon, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetch("https://us1.locationiq.com/v1/search?key=" + apiKey + "&q=" + encodeURIComponent(address) + "&format=json")];
                    case 2:
                        response = _b.sent();
                        if (!response.ok) {
