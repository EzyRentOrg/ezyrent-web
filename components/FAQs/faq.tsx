      ...
      <div className=" mx-auto space-y-6">
        ...
        >
          <div className="flex items-center ">
            {/* icon left */}
            <Link2 />
            <div className="flex w-full items-center justify-between rounded-md bg-muted px-4 py-2 lg:py-5  text-left font-medium transition-colors hover:bg-muted/50 focus:outline-none focus-visible:ring focus-visible:ring-primary focus-visible:ring-opacity-75">
              <p className="text-[#000929] font-[500] text-base md:text-[1.25rem] lg:text-[1.5rem] w-full">
                {question}
              </p>
              <div
                onClick={() => setIsOpenAnser(!isOpenAnswer)}
