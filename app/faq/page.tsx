        ...
        <main>
          <div className='flex flex-col items-center space-y-10 mt-5 max-w-[720px] mx-auto'>
            <div className="flex flex-col items-center">
              <h1 className='text-[#7065F0] font-semibold md:text-[1.5rem] lg:text-[2rem] leading-[57.2px] capitalize'>Frequently Asked Questions</h1>
            ...
            <div className="relative w-full max-w-[520px]">
              ...
              <div className="absolute right-4 top-1/2 transform -translate-y-1/2 flex items-center space-x-5">
                <Separator orientation={"vertical"} className="h-6 bg-[#E6E6E6] w-[2px]"/>
              <Search
                size={30}
                stroke={"#7065F0"}
