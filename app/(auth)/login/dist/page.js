...
function Login() {
    ...
    var form = react_hook_form_1.useForm({
        resolver: zod_1.zodResolver(validations_1.loginSchema),
        mode: 'all',
        defaultValues: {
            email: ''
        }
        ...
        react_1["default"].createElement("section", { className: "min-h-[984px] mx-auto mb-10 flex items-center space-x-10" },
            react_1["default"].createElement("main", { className: "h-[964px] w-full flex flex-col " },
                react_1["default"].createElement("div", { className: "bg-[#F8F8F8] h-full mb-10 rounded-[20px] pt-[120px]" },
                    react_1["default"].createElement("div", { className: "md:w-[80%] mx-auto pb-10" },
                        react_1["default"].createElement("div", null,
                            ...
                            react_1["default"].createElement("p", { className: "my-[2px] text-[#475467] text-[1.25rem] leading-[28px] font-bold -tracking-[2%]" }, "Find, Rent, and Manage Properties Seamlessly"),
