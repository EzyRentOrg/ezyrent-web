...
function ResetPassword() {
    ...
    var form = react_hook_form_1.useForm({
        resolver: zod_1.zodResolver(validations_1.resetPasswordSchema),
        mode: 'all',
        defaultValues: {
            password: '',
            confirmPassword: ''
                ...
                react_1["default"].createElement("div", { className: "bg-[#F8F8F8] h-full mb-10 rounded-[20px] pt-[120px]" },
                    react_1["default"].createElement("div", { className: "ml-5 pb-5" },
                        react_1["default"].createElement("div", null,
                            react_1["default"].createElement(button_1.Button, { variant: 'ghost', onClick: function () { return router.back(); }, className: "capitalize text-[#475467] hover:text-opacity-85 transition-colors duration-100 ease-in-out font-medium text-[1rem] leading-[22.4px] " },
                                react_1["default"].createElement(lucide_react_1.ArrowLeft, { size: 18, className: "inline-flex ml-2" }),
                                " back")),
                        react_1["default"].createElement("div", { className: "md:w-[80%] mx-auto" },
                            react_1["default"].createElement("div", { className: "my-5 text-center flex flex-col items-center justify-center space-y-2" },
                                react_1["default"].createElement("h2", { className: "text-[#344054] text-[1.5rem] font-extrabold leading-[33.6px] -tracking-[2%]" }, "Create a New password"),
                                react_1["default"].createElement("p", { className: "my-1px text-[#475467] text-[0.875rem] leading-[28px] font-medium -tracking-[2%]" }, "Enter your new password below to complete the reset process. Ensure its Strong and secure")),
                            react_1["default"].createElement(form_1.Form, __assign({}, form),
                                react_1["default"].createElement("form", { onSubmit: handleSubmit(onSubmit), className: "grid gap-6 mt-6" },
                                    react_1["default"].createElement(form_1.FormField, { control: form.control, name: "password", render: function (_a) {
                                            ...
                                            return (react_1["default"].createElement(form_1.FormItem, null,
                                                react_1["default"].createElement(form_1.FormLabel, { className: "capitalize text-[#475467] font-semibold text-[1rem] leading-[22.4px]" }, "new password"),
                                    ...
                                    react_1["default"].createElement(form_1.FormField, { control: form.control, name: "confirmPassword", render: function (_a) {
                                            var field = _a.field;
                                            return (react_1["default"].createElement(form_1.FormItem, null,
                                                react_1["default"].createElement(form_1.FormLabel, { className: "capitalize text-[#475467] font-semibold text-[1rem] leading-[22.4px]" }, "repeat new password"),
                                                react_1["default"].createElement(form_1.FormControl, null,
                                                    react_1["default"].createElement("div", { className: "relative flex items-center " },
                                                        react_1["default"].createElement("div", { className: "absolute left-5 flex items-center space-x-4" },
                                                            react_1["default"].createElement(lucide_react_1.Lock, { size: 20, stroke: "#9E77ED" }),
                                    ...
                                    react_1["default"].createElement(button_1.Button, { type: "submit", className: utils_1.cn('bg-[#000929] h-[72px] !mt-8 w-full capitalize text-[1.25rem] font-medium leading-[28px] mx-auto rounded-[80px] hover:bg-opacity-85 transition-colors duration-150', {
