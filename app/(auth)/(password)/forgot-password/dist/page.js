...
function ForgotPassword() {
    ...
    var form = react_hook_form_1.useForm({
        resolver: zod_1.zodResolver(validations_1.forgotPasswordSchema),
        mode: 'all',
        defaultValues: {
            email: ''
        }
                    ...
                    react_1["default"].createElement("div", { className: "ml-5 pb-5" },
                        ...
                        react_1["default"].createElement("div", { className: "md:w-[80%] mx-auto" },
                            react_1["default"].createElement("div", { className: "my-10 text-center flex flex-col items-center justify-center space-y-4" },
                                react_1["default"].createElement("h2", { className: "capitalize text-[#344054] text-[1.5rem] font-extrabold leading-[33.6px] -tracking-[2%]" }, "Forgot Password"),
                                react_1["default"].createElement("p", { className: "my-1px text-[#475467] text-[0.875rem] leading-[28px] font-medium -tracking-[2%]" }, "No worries! Enter your email address below, and we'll send you a link to reset your password.")),
                                ...
                                react_1["default"].createElement("form", { onSubmit: handleSubmit(onSubmit), className: " mt-6" },
                                    react_1["default"].createElement(form_1.FormField, { control: form.control, name: "email", render: function (_a) {
                                            ...
                                            return (react_1["default"].createElement(form_1.FormItem, null,
                                                react_1["default"].createElement(form_1.FormLabel, { className: "text-[#475467] font-semibold text-[1rem] leading-[22.4px]" }, "Email"),
